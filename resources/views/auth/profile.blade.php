				...
				<form class="form-horizontal">
				  	<fieldset>
						<div class="control-group">
	        				...
	        				<div class="controls">
	        					<input type="date" class="span6 typeahead form-control" id="dob" placeholder="02/16/00" value="{{ $user->personalInfo->DOB }}">
	        				</div>
	    				</div>
						<div class="control-group">
		  					<label class="control-label" for="typeahead">WeChat </label>
		  					<div class="controls">
								<input type="text" class="span6 typeahead form-control" value="{{ $user->personalInfo->WeChat }}" name="WeChat">
		 					</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
			  				...
			  				<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="Parent 1" value="{{ $user->personalInfo->parent1 }}" name="parent1"><br>
								<input type="text" class="span6 typeahead form-control" placeholder="Parent 2" value="{{ $user->personalInfo->parent2 }}" name="parent2">
			  				</div>
						</div>
						...
						<div class="control-group">
						  	...
						  	<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="Smith High School" value="{{ $user->personalInfo->highSchool }}" name="highSchool">
						  	</div>
						</div>
						...
						<div class="control-group">
						  	...
						  	<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="1500" value="{{ $user->personalInfo->SAT }}" name="SAT">
						  	</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="typeahead">ACT </label>
						  	<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="21" value="{{ $user->personalInfo->ACT }}" name="ACT">
						  	</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="typeahead">TOEFL </label>
						  	<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="80" value="{{ $user->personalInfo->TOEFL }}" name="TOEFL">
						  	</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="typeahead">GPA</label>
							<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="3.8" value="{{ $user->personalInfo->GPA }}" name="GPA">
						  	</div>
						</div>
						...
						<div class="control-group">
			  				...
			  				<div class="controls">
								<input type="text" class="span6 typeahead form-control" placeholder="Computer Science" value="{{ $user->personalInfo->major1 }}" name="major1"><br>
								<input type="text" class="span6 typeahead form-control" placeholder="Engineering" value="{{ $user->personalInfo->major2 }}" name="major2"><br>
								<input type="text" class="span6 typeahead form-control" placeholder="Biology" value="{{ $user->personalInfo->major3 }}" name="major3">
			  				</div>
			  			</div>
			  			@endif <!-- $studentCheck -->
