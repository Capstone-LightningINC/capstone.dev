			...
			<form class="form-horizontal">
			  	<fieldset>
					<div class="control-group">
					  	...
					  	<div class="controls">
							<input type="text" class="span6 typeahead" value="{{ $user->name }}" name="name">
					   	</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" class="span6 typeahead" value="{{ $user->preferred_name }}" name="preferred_name">
						</div>
					</div>
					...
					<div class="control-group">
					  	...
					  	<div class="controls">
							<input type="text" class="span6 typeahead" value="{{ $user->email }}" name="email">
					  	</div>
					</div>
					...
					<div class="control-group">
						<label class="control-label" for="typeahead">Phone</label>
					  	<div class="controls">
							<input type="text" class="span6 typeahead" value="{{ $user->phone }}" name="phone">
					  	</div>
					</div>
...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="control-group">
		  	...
		  	<div class="controls">
				<input type="text" class="span6 typeahead" value="{{ $user->personalInfo->WeChat }}" name="WeChat">
		 	</div>
		</div>
		...
		@if($studentCheck)
			<div class="control-group">
			  	...
			  	<div class="controls">
					<input type="text" class="span6 typeahead" placeholder="Parent 1" value="{{ $user->personalInfo->parent1 }}" name="parent1"><br>
					<input type="text" class="span6 typeahead" placeholder="Parent 2" value="{{ $user->personalInfo->parent2 }}" name="parent2">
			  	</div>
			</div>
			...
			<div class="control-group">
			  	...
			  	<div class="controls">
					<input type="text" class="span6 typeahead" placeholder="Smith High School" value="{{ $user->personalInfo->highSchool }}" name="highSchool">
			  	</div>
			</div>
			...
			<div class="control-group">
			  	...
			  	<div class="controls">
					<input type="text" class="span6 typeahead" placeholder="1500" value="{{ $user->personalInfo->SAT }}" name="SAT">
			  	</div>
			</div>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<input type="text" class="span6 typeahead" placeholder="21" value="{{ $user->personalInfo->ACT }}" name="ACT">
			  </div>
			</div>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<input type="text" class="span6 typeahead" placeholder="80" value="{{ $user->personalInfo->TOEFL }}" name="TOEFL">
			  </div>
			</div>
			...
			<div class="control-group">
			  ...
			  <div class="controls">
				<input type="text" class="span6 typeahead" placeholder="3.8" value="{{ $user->personalInfo->GPA }}" name="GPA">
			  </div>
			</div>
			...
			<div class="control-group">
			  	...
			  	<div class="controls">
					<input type="text" class="span6 typeahead" placeholder="Computer Science" value="{{ $user->personalInfo->major1 }}" name="major1"><br>
					<input type="text" class="span6 typeahead" placeholder="Engineering" value="{{ $user->personalInfo->major2 }}" name="major2"><br>
					<input type="text" class="span6 typeahead" placeholder="Biology" value="{{ $user->personalInfo->major3 }}" name="major3">
			  	</div>
			</div>
